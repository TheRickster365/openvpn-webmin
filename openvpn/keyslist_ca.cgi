...
print &ui_table_row($text{'key_password'}, &ui_password('KEY_PASSWD',$$info_ca{'KEY_PASSWD'},50),'',[ 'nowrap',1 ]);
...
print &ui_table_row($text{'key_pkcs12'}, &ui_select('KEY_PKCS12', $$info_ca{'KEY_PKCS12'}, [ [1,$text{'no'}],[2,$text{'yes'}] ]),'',[ 'nowrap',1 ]);
print &ui_table_row($text{'key_pkcs12_password'}, &ui_password('KEY_PKCS12_PASSWD',$$info_ca{'KEY_PKCS12_PASSWD'},50),'',[ 'nowrap',1 ]);
...
print &ui_table_row($text{'ou'}, &ui_textbox('KEY_OU', $$info_ca{'KEY_OU'},50),'',[ 'nowrap',1 ]);
